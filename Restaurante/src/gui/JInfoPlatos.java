...
//setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		cbxCantidad.setBounds(403, 70, 56, 29);
...
//mostrar lista platos
		...
		case "EliminarPlato":
			...
			btnAceptar_1.setVisible(false);
			comboBox.setModel(new DefaultComboBoxModel(administrador.getPlatosTotal()));
			lblIngredientes.setText("Platos");
...
//mostrar la lista de ingredientes para que seleccione y le asigne la cantidad
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(btnAceptar_1 == e.getSource()) {
			...
			Ingredientes ingreBox=new Ingredientes(h.getNombre(),cbxCantidad.getSelectedIndex()+1);
			ingre[ingre.length-1]=ingreBox;
			JOptionPane.showMessageDialog(null,"El Ingrediente ha sido agregado exitosamente");
		}
...
//mostrar lista platos
			case "ModificarPPlato":
				String plato1 = txtNombrePlato.getText().toLowerCase();
			...
			case "EliminarPlato":
				...
				try {
					...
					JOptionPane.showMessageDialog(null, "El plato se ha eliminado exitosamente");
					break;
			...
			case "AddPlato":
				String plato2 = txtNombrePlato.getText().toLowerCase();
...
//mostrar la lista de ingredientes para que seleccione y le asigne la cantidad
			...
			case "ModificarIPlato":
				String plato3 = txtNombrePlato.getText().toLowerCase();
				try {
					administrador.ModificarIngrePlato(plato3, ingre);
